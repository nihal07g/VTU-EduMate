...
export function ModeSelector() {
  ...
  const activeClasses = "bg-gray-800 shadow-lg text-indigo-300";
  const inactiveClasses = "bg-transparent text-gray-400 hover:bg-gray-800/50";

  return (
    <div className="max-w-md mx-auto my-8 p-2 bg-gray-800 rounded-xl flex items-center space-x-2 border border-gray-700">
