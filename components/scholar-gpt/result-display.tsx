...
interface ResultDisplayProps {
  result: any;
  onMarksSubmit: (marks: number) => void;
}

export function ResultDisplay({ result, onMarksSubmit }: ResultDisplayProps) {
    ...
    const handleMarksInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
