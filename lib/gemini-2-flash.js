...
function extractKeywordsFromQuestion(question: string, subject: string): string[] {
...
function calculateRelevance(question: string, keywords: string[]): number {
...
function getDefaultVideoRecommendations(subject: string, branch: string): VideoRecommendation[] {
  return [
    {
